...
<main class="main-content">
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Add, edit, search and remove medicines from the inventory</p>
        </div>
    </div>
                ...
                <tbody id="tableBody">
                    ...
                    <?php else: ?>
                        <?php foreach ($books as $i => $book): ?>
                            <tr>
                                <td><?= $i + 1 ?></td>
                                <td><?= htmlspecialchars($book['medicine_name']) ?></td>
                                <td><?= htmlspecialchars($book['company']) ?></td>
